...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set TargetDir {C:/ISDBS/10k_20/rfsoc_qpsk/boards/ip/sysgen/iprepo/zcu111/rx/rx_decimation}
	set TopLevelModule {axi_qpsk_rx_dec}
	set TopLevelSimulinkHandle 2.2467
	...
	dict set TopLevelPortInterface m_axis_tdata Period 2560
	...
	dict set TopLevelPortInterface m_axis_tvalid Period 2560
