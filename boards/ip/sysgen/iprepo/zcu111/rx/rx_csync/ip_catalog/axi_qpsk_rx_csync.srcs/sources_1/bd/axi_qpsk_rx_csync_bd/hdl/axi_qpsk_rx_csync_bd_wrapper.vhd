...
--Command     : generate_target axi_qpsk_rx_csync_bd_wrapper.bd
--Design      : axi_qpsk_rx_csync_bd_wrapper
...
entity axi_qpsk_rx_csync_bd_wrapper is
  port (
...
end axi_qpsk_rx_csync_bd_wrapper;

architecture STRUCTURE of axi_qpsk_rx_csync_bd_wrapper is
  component axi_qpsk_rx_csync_bd is
  port (
    CLK_IN1_D_clk_n : in STD_LOGIC;
    CLK_IN1_D_clk_p : in STD_LOGIC;
    reset_rtl : in STD_LOGIC;
  ...
  end component axi_qpsk_rx_csync_bd;
begin
axi_qpsk_rx_csync_bd_i: component axi_qpsk_rx_csync_bd
     port map (
